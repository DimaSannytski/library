...
public class BookController {
	...
	@PostMapping("/create")
	public String createBook(Principal principal, @ModelAttribute("createBook")@Valid BookCreateDto request,
	...
	@PostMapping("/edit")
	public String editBook(@RequestParam("bookId") long bookId, Principal principal,
						   @ModelAttribute("bookModel")@Valid BookCreateDto request, BindingResult result) {
	...
	public String createCopy(@RequestParam("bookId") long bookId, Principal principal,
							 @ModelAttribute("countModel")@Valid CountDto request, BindingResult result) {
